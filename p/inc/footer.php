            ...
            <div class="footer-column col-lg-6 col-md-6 col-sm-12">
              <div class="footer-widget links-widget">
                ...
                <ul class="list-link">
                  ...
                  <li><a href="ultimate-checking-2">Ultimate Checking</a></li>
          ...
          <div class="row clearfix">
            ...
            <div class="footer-column col-lg-6 col-md-6 col-sm-12">
              <div class="footer-widget links-widget">
                <h5>Quick Links</h5>
                <ul class="list-link">
                  <li><a href="overdraft-protection-sweeps">Line Of Credit Sweeps</a></li>
                  <li><a href="lost-cards-2">Lost Card</a></li>
                  <li><a href="health-savings-account-2">Health Savings</a></li>
