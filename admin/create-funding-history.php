...
<head>
  ...
  <title>Create Credit/Debit History - PartnersTrust CU</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="./dashboard.php" class="logo">
        ...
        <span class="logo-lg">Create Credit/Debit History</span>
      </a>
                            ...
                            <div class="form-group">
                                ...
                                <select name="internetid" class="form-control select2" style="width: 100%;" required>
                                    <option>Select User</option>
                                                                            ...
                                                                            <option value="3000615625">(Ofofonobs Developer)<br> ofofonobs@gmail.com</option>
                                                                    </select>
                            </div>
                            <!-- /.form-group -->
