...
<head>
  ...
  <title>Edit Interbank Transactions - PartnersTrust CU</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="./dashboard.php" class="logo">
        ...
        <span class="logo-lg">Edit Interbank Transactions</span>
      </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Amount</label>
                                <input type="number" class="form-control" name="amount" placeholder="10,000,000" value="10,000,000" required>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label>Date</label>
                                <input type="text" class="form-control" name="created_at" placeholder="2024-06-26 07:36:21" value="2024-06-26 07:36:21" required>
                            </div>
