...
<head>
  ...
  <title>Settings - PartnersTrust CU</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="./dashboard.php" class="logo">
        ...
        <span class="logo-lg">Settings</span>
      </a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="website_name" value="PartnersTrust CU" placeholder="PartnersTrust CU ">
                            </div>
                            <!-- /.form-group -->
                            <div class="form-group">
                                <label>Request Card fee</label>
                                <input type="text" class="form-control" name="cardfee" value="20" placeholder="Card Fee">
                            </div>
                            <div class="form-group">
                                <label>Wire Transfer fee</label>
                                <input type="text" class="form-control" name="wirefee" value="35" placeholder="Wire Transfer Fee">
                            </div>
                            <div class="form-group">
                                <label>Domestice Transfer fee</label>
                                <input type="text" class="form-control" name="domesticfee" value="30" placeholder="Domestic Transfer Fee">
                            </div>

                            <div class="form-group">
                                <label>Domestice Transfer Limit</label>
                                <input type="text" class="form-control" name="domesticlimit" value="50000000" placeholder="Domestic Transfer Limit">
                            </div>
                            

                            <div class="form-group">
                                <label>User Transfer Option: <span style="color: red;">Activated</span></label>
                            ...
                            <div class="form-group">
                                <label>Padiwise Config Option: <span style="color: red;">Disactivated</span> </label>
                            ...
                            <div class="form-group">
                                <label>Billing Code Option: <span style="color: red;">Activated</span> </label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="website_email" value="support@partnerstrustcu.com" placeholder="support@partnerstrustcu.com ">
                            </div>
                            <div class="form-group">
                                <label>System Phone</label>
                                <input type="text" class="form-control" name="website_tel" value="2348114313795" placeholder="2348114313795">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="loanlimit" value="1000000" placeholder="Loan Limit">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="wirelimit" value="50000000" placeholder="Wire Transfer Limit">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="tax_code" value="TAX7678" placeholder="TAX7678">
                            </div>


                            <div class="form-group">
                                <label>IMF CODE</label>
                                <input type="text" class="form-control" name="imf_code" value="IMF6578" placeholder="IMF6578">
                            </div>

                            <div class="form-group">
                                <label>COT CODE</label>
                                <input type="text" class="form-control" name="cot_code" value="COT7678" placeholder="COT7678">
                            </div>
