...
<head>
  ...
  <title>Deposit Transactions - PartnersTrust CU</title>
              ...
              <div class="table-responsive">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php
                    $count = 1;
                    foreach ($Authroller->pendingTransactions() as $key => $value) {
                      $user = $Authroller->singleUser($value['user_id']);
                      ?>
                    <tr>
                      ...
                      <td>
                        <a href="../assets/images/deposits/<?php echo $value['proof']; ?>" target="_blank">View reciept</a>
                      </td>
                      ...
                      <td class="p-0">
                        <?php
                          if ( $value['status'] == 'pending' ) {
                            ?>
                        <a id="statusBtn<?php echo $value['id']; ?>" onclick="approveDeposit(<?php echo $value['id']; ?>)" class="btn p-0 text-success">Confirm</a>
                            <?php
                          }else {
                            echo "<i class='fa fa-check text-success'></i>";
                          }
                        ?>
                        <!-- <a id="statusBtn<?php echo $value['id']; ?>" onclick="deleteDeposit(<?php echo $value['id']; ?>)" class="btn p-0 text-danger">Delete</a> -->
                      </td>
                    </tr>
                      <?php
                      $count++;
