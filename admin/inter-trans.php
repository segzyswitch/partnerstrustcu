...
<head>
  ...
  <title>Interbank Transactions - PartnersTrust CU</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="./dashboard.php" class="logo">
        ...
        <span class="logo-lg">Interbank Transactions</span>
      </a>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                            ...
                                            <td class="text-center">
                                              <a href="./view-intertrans.php?id=667f88be9f983" class="btn btn-primary">Edit</a>
                                                <a href="./delete_inter.php?id=667f88be9f983" class="btn btn-danger">Del</a>
                                            ...
                                            <td><span class="text-success">Transaction Completed</span></td>
                                            <td class="text-center">
                                              <a href="./view-intertrans.php?id=667f88be9f766" class="btn btn-primary">Edit</a>
                                                <a href="./delete_inter.php?id=667f88be9f766" class="btn btn-danger">Del</a>
                                                <a href="./view_users.php?id=1" target="_blank" class="btn btn-success">View User</a>
                                            </td>
                                            ...
                                            <td><span class="text-success">Transaction Completed</span></td>
                                            <td class="text-center">
                                              <a href="./view-intertrans.php?id=667bfd350820f" class="btn btn-primary">Edit</a>
                                                <a href="./delete_inter.php?id=667bfd350820f" class="btn btn-danger">Del</a>
                                                <a href="./view_users.php?id=1" target="_blank" class="btn btn-success">View User</a>
                                            </td>
                                            ...
                                            <td><span class="text-success">Transaction Completed</span></td>
                                            <td class="text-center">
                                              <a href="./view-intertrans.php?id=667bfd3507f7d" class="btn btn-primary">Edit</a>
                                                <a href="./delete_inter.php?id=667bfd3507f7d" class="btn btn-danger">Del</a>
                                                <a href="./view_users.php?id=1" target="_blank" class="btn btn-success">View User</a>
                                            </td>
