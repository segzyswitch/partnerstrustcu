...
<head>
  ...
  <title>Login - PartnersTrust CU</title>
...
<div class="login-box">
  <div class="text-center" style="margin-bottom:20px;">
    <img src="../ui/assets/img/favicon.ico" width="50" oncontextmenu="return false" />
  </div>
  <!-- /.login-logo -->
    ...
    <form id="loginForm" method="post" autocomplete="off">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          ...
          <button type="submit" class="btn btn-primary btn-block btn-flat submit-btn">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
...
$("#loginForm").on('submit', function(){
  ...
  $.ajax({
    ...
    processData: false,
    beforeSend: function() {
    $("#loginForm .submit-btn").html("Logging in <i class='fa fa-cog fa-spin'></i>");
    },
