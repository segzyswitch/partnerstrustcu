...
<head>
  ...
  <title>Edit Admin Profile - PartnersTrust CU</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="./dashboard.php" class="logo">
        ...
        <span class="logo-lg">Edit Admin Profile</span>
      </a>
                ...
                <div class="box box-primary">
                    ...
                    <form enctype="multipart/form-data" method="POST">
                        <div class="box-body">
                                ...
                                <input type="text" disabled class="form-control" placeholder="Ofofonobs Developer">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Admin Email</label>
                                <input type="email" name="admin_email" class="form-control" value="support@partnerstrustcu.com" placeholder="Admin Email" required>
                            </div>
                        </div>
                        <!-- /.box-body -->
            ...
            <div class="col-md-6">
                ...
                <div class="box box-primary">
                    ...
                    <form enctype="multipart/form-data" method="POST">
                        ...
                        <div class="box-footer">
                            <button type="submit" name="change_password" class="btn btn-primary" disabled> DEMO: Change Password</button>
                        </div>
                    </form>
                </div>
                <!-- /.box -->
