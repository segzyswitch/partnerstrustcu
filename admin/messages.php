...
<head>
  ...
  <title>Support Ticket - PartnersTrust CU</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="./dashboard.php" class="logo">
        ...
        <span class="logo-lg">Support Ticket</span>
      </a>
                        ...
                        <div class="table-responsive">
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                            ...
                                            <td>1</td>
                                            <td>ofofonobs@gmail.com</td>
                                            <td>Ofofonobs Developer</td>
                                            <td>open</td>
                                            <td>2023-06-07 10:24:46</td>
                                            <td class="text-center"><a href="./viewticket.php?id=7" class="btn btn-primary">Update</a>
                                                <a href="./view_users.php?id=1" class="btn btn-danger">View User</a>
                                            </td>
                                        </tr>
                                            ...
                                            <td>open</td>
                                            <td>2023-06-07 10:24:46</td>
                                            <td class="text-center"><a href="./viewticket.php?id=6" class="btn btn-primary">Update</a>
                                                <a href="./view_users.php?id=1" class="btn btn-danger">View User</a>
                                            </td>
                                        </tr>
                                            ...
                                            <td>closed</td>
                                            <td>2023-06-07 10:24:46</td>
                                            <td class="text-center"><a href="./viewticket.php?id=5" class="btn btn-primary">Update</a>
                                                <a href="./view_users.php?id=1" class="btn btn-danger">View User</a>
                                            </td>
                                        </tr>
                                            ...
                                            <td>processing</td>
                                            <td>2023-06-07 10:24:46</td>
                                            <td class="text-center"><a href="./viewticket.php?id=4" class="btn btn-primary">Update</a>
                                                <a href="./view_users.php?id=1" class="btn btn-danger">View User</a>
                                            </td>
                                        </tr>
                                            ...
                                            <td>closed</td>
                                            <td>2023-06-07 10:24:46</td>
                                            <td class="text-center"><a href="./viewticket.php?id=3" class="btn btn-primary">Update</a>
                                                <a href="./view_users.php?id=1" class="btn btn-danger">View User</a>
                                            </td>
                                        </tr>
                                            ...
                                            <td>open</td>
                                            <td>2023-06-07 10:24:46</td>
                                            <td class="text-center"><a href="./viewticket.php?id=2" class="btn btn-primary">Update</a>
                                                <a href="./view_users.php?id=1" class="btn btn-danger">View User</a>
                                            </td>
                                        </tr>
                                            ...
                                            <td>open</td>
                                            <td>2023-06-07 10:24:46</td>
                                            <td class="text-center"><a href="./viewticket.php?id=1" class="btn btn-primary">Update</a>
                                                <a href="./view_users.php?id=1" class="btn btn-danger">View User</a>
                                            </td>
                                        </tr>
