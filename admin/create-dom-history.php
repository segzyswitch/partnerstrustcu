...
<head>
	...
	<title>Create Domestic History - PartnersTrust CU</title>
		...
		<section class="content">
			...
			<form id="transactionForm" method="POST" class="box box-default">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select name="payment_account" class="form-control select2 w-100" required>
										<option value="">Select Payment Account</option>
										<option value="savings"><strong></strong> Savings Account</option>
										<option value="current"><strong></strong> Current Account</option>
									</select>
								</div>
							</div>
							<div class="col-md-6">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select name="trans_type" class="form-control select2 w-100" required>
										<option value="">Select Transaction Type</option>
										<option value="credit"><strong></strong> Credit</option>
										<option value="debit"><strong></strong> Debit</option>
									</select>
								</div>
							</div>
							<div class="col-md-6">
				...
				<div class="box-footer">
					<input type="hidden" name="create_local_transaction">
					<button type="submit" name="credit" class="btn btn-primary submit-btn">Create transaction</button>
				</div>
			</form>
			<!-- /.box -->
		</section>
