...
<head>
    ...
    <title>Loan Request - PartnersTrust CU </title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Loan Request</span></li>
                            </ol>
                        </nav>
                        ...
                        <div class="widget-content widget-content-area">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input type="text" hidden value="3000615625" name="internetid">
                                ...
                                <div class="input-group mb-4">
                                    <select class="form-control  basic" required name="payment_account">
                                        ...
                                        <option value="savings_account"><strong>(3597456900)</strong> Savings: $958.00</option>
                                        <option value="current_account"><strong>(7654456987)</strong> Current: $54,752.00</option>
                                    </select>
                                </div>
