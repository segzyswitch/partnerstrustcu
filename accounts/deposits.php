...
<head>
	...
	<title>Pending Deposits - PartnersTrust CU </title>
				...
				<div class="page-header">
					<nav class="breadcrumb-one" aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page"><span>Pending Deposits</span></li>
						</ol>
					</nav>
				</div>
			</li>
						...
						<table class="table mb-4">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-primary text-capitalize"><?php echo $value['type']; ?> Deposit</td>
									<td>
										<a class="btn btn-primary btn-sm py-1 rounded px-2"
											href="../assets/images/deposits/<?php echo $value['proof']; ?>"
											target="_blank">
											<i class="fa fa-file-text"></i>
											<span> View</span>
										</a>
									</td>
									<td class=""><span class="shadow-none badge outline-badge-warning">pending</span></td>
