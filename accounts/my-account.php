...
<head>
	...
	<title>My Account - PartnersTrust CU</title>
									...
									<div class="info">
										...
										<div class="row">
											<div class="col-lg-11 mx-auto">
												<div class="row">
													<form class="col-xl-2 col-lg-12 col-md-4"
														id="uploadImageForm" 
														...
														<div class="upload mt-4 pr-md-4">
															<input type="file"
																...
																data-default-file="../assets/images/users/<?php echo $user_info['photo']; ?>"
																data-max-file-size="2M" required
															/>
															<input type="hidden" name="MAX_FILE_SIZE" value="10485760" />
															<input type="hidden" name="upload_photo" value="upload" />
															<button class="mt-2 submit-btn" type="submit"><i class=" fa fa-cloud-upload mr-1"></i> Upload Picture</button>
														</div>
													</form>
															...
															<div class="row">
																<div class="col-sm-6">
																	<div class="form-group">
																		...
																		<p><?php echo $Controller->fullName(); ?></p>
																	</div>
																</div>
																<div class="col-sm-6">
																	<div class="form-group">
																		<label for="fullName">Username / Email Address</label>
															...
															<div class="row">
																<div class="col-sm-6">
																	<div class="form-group">
																		...
																		<p class="text-uppercase"><?php echo $user_info['status']; ?></p>
																	</div>
																</div>
																<div class="col-sm-6">
																	<div class="form-group">
