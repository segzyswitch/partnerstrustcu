...
<head>
    ...
    <title>My Loans - PartnersTrust CU </title>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>My Loans</span></li>
                            </ol>
                        </nav>
                    ...
                    <table class="table mb-4">
                        ...
                        <tbody>
                                    ...
                                    <td class="text-center">1</td>
                                        ...
                                        <td><span class="text-success">+$50,000.00</span></td>


                                                                        <td>Business Loan</td>
                                    <td>3 Months</td>
                                    <td class="">processing</td>
                                    <td>2024-07-02 19:16:53</td>
