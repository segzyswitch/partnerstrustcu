...
<head>
	...
	<title>Last 50 Activities - PartnersTrust CU </title>
				...
				<div class="page-header">
					...
					<nav class="breadcrumb-one" aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page"><span>Last 50 Activities</span></li>
						</ol>
					</nav>
								...
								<?php
									...
									foreach ($Controller->userActivity() as $key => $value) {
										...
										<tr>
											...
											<td><?php echo $value['feed']; ?></td>
											<td><?php echo date('h:i:s d/m/Y', strtotime($value['createdat'])); ?></td>
										</tr>
										<?php
										$count++;
									}
