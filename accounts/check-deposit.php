...
<head>
	...
	<title>Mobile Check Deposit - PartnersTrust CU</title>
				...
				<div class="page-header">
					<nav class="breadcrumb-one" aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page"><span>Mobile Check Deposit</span></li>
						</ol>
					</nav>
				</div>
			</li>
					...
					<div id="basic" class="col-lg-6 mx-auto">
						...
						<div class="statbox widget box box-shadow">
							...
							<div id="fuSingleFile" class="col-lg-12 layout-spacing">
								<div class="statbox widget box box-shadow">
									<form method="POST" id="chequeDepositForm" enctype="multipart/form-data">
										<div class="widget-content widget-content-area">
											...
											<div class="input-group mb-4">
												...
												<input type="text" name="amount" class="form-control" required placeholder="Amount on Check">
											</div>
											...
											<div class="custom-file-container" data-upload-id="myFirstImage">
												<div class="d-flex">
													<label>Please upload check deposit below</label>
													<a href="javascript:void(0)" class="custom-file-container__image-clear ml-auto text-danger">clear</a>
												</div>
												<label class="custom-file-container__custom-file">
													<input type="file"name="image" class="custom-file-container__custom-file__custom-file-input"  accept="image/*" required>
													<input type="hidden" name="check_deposit" value="10485760" />
											...
											<center>
												<button type="submit"
													class="btn btn-primary sibmit-btn"
